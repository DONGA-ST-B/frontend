        ...
        <MainSelectGroupWrapper>
            ...
            <MainSelectRow>
                <MainSelectItem
                    ...
                    content={(
                        <>
                            18g의 가벼운 무게를 지닌 일체형<br />모델이므로, 컴팩트하여 누구나 쉽게<br />착용할 수 있습니다.
                        </>
                    )}
                />
                <MainSelectItem
                    ...
                    content={(
                        <>
                            하이카디는 소아/신생아용 홀터 진단에서<br />요구하는 시험결과를 제출해 인증 받은<br />제품이므로, 소아 및 신생아에게도 사용이<br />가능합니다.
                        </>
                    )}
                />
                <MainSelectItem
                    ...
                    content={(
                        <>
                            Defivirillation Protection 기능이 탑재되어<br />착용한 상태로 제세동기 사용이 가능합니다.
                        </>
                    )}
                />
            </MainSelectRow>
